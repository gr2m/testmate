...
module.exports = function(options, callback) {
  ...
  if (! fs.existsSync(path.resolve(__dirname, '../node_modules/chai')) ) {
    fs.symlinkSync(
      path.resolve(process.env.PWD, 'node_modules/chai'),
      path.resolve(__dirname, '../node_modules/chai'),
      'dir'
    );
  }
  if (! fs.existsSync(path.resolve(__dirname, '../node_modules/mocha')) ) {
    fs.symlinkSync(
      path.resolve(process.env.PWD, 'node_modules/mocha'),
